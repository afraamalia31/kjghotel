...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <meta name="author" content="Jadwal galeri">
    ...
    <body>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="width: 90px;text-align: center;">
                                                    <a href="javascript:void(0);" class="btn btn-sm btn-secondary btn-circle btn-edit" data-id="<?php echo $row->kd_galeri;?>" data-nama="<?php echo $row->nama;?>" ?><span class="fa fa-pencil"></span></a>
                                                    <a href="javascript:void(0);" class="btn btn-sm btn-secondary btn-circle btn-hapus" data-id="<?php echo $row->kd_galeri;?>"><span class="fa fa-trash"></span></a>
                                                </td>
                                            </tr>
                                        <?php endforeach;?>
                                        </tbody>
        ...
        <!-- Modal Hapus -->
        <form action="<?php echo base_url().'admin/galeri/simpan_galeri'?>" method="post">
        ...
        <!-- Modal Hapus -->
        <form action="<?php echo base_url().'admin/galeri/update_galeri'?>" method="post">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content">
                            <p>Anda yakin mau menghapus galeri ini?</p>
