...
<html lang="en" class="no-focus"> <!--<![endif]-->
    ...
    <body>
                        ...
                        <div class="col-md-12">
                            <div class="block">
                                <div class="block-header block-header-default">
                                    <h3 class="block-title">Daftar Galeries</h3>
                                ...
                                <div class="block-content block-content-full">
                                    <table id="mytable" class="table table-striped">
                                        ...
                                        <?php 
                                            $no=0;
                                            foreach ($galeriess->result() as $row) :
                                            $no++;
                                        ?>
                                            <tr>
                                                ...
                                                <td style="width: 90px;text-align: center;vertical-align: middle;">
                                                    <a href="javascript:void(0);" class="btn btn-sm btn-secondary btn-circle" data-toggle="modal" data-target="#ModalEdit<?php echo $row->kd_galeries;?>"><span class="fa fa-pencil"></span></a>
                                                    <a href="javascript:void(0);" class="btn btn-sm btn-secondary btn-circle btn-hapus" data-id="<?php echo $row->kd_galeries;?>"><span class="fa fa-trash"></span></a>
                                                </td>
                                            </tr>
                                        <?php endforeach;?>
                                        </tbody>
            ...
            <footer id="page-footer" class="opacity-0">
                <div class="content py-20 font-size-xs clearfix">
                    <div class="float-right">
                        Created with <i class="fa fa-heart text-pulse"></i> by <a class="font-w600" href="#" target="_blank">Afra Amalia</a>
                    </div>
                    <div class="float-left">
                        <a class="font-w600" href="#" target="_blank">Afra Amalia</a> &copy; <span class="js-year-copy"><?php echo date('Y');?></span>
                    </div>
                </div>
            </footer>
            <!-- END Footer -->
        ...
        <!-- Modal Hapus -->
        <form action="<?php echo base_url().'admin/galeries/simpan_galeries'?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="block-content">
                            ...
                            <div class="form-group">
                                <select name="xjadwal" class="form-control" required>
                                    ...
                                    <?php foreach($galeri->result() as $j):?>
                                    <option value="<?php echo $j->kd_galeri;?>"><?php echo $j->nama;?></option>
                                    <?php endforeach;?>
                                </select>
                            </div>
                            <!-- <div class="form-group">
                                <input type="text" name="xgaleries" class="form-control" placeholder="galeries" required>
                            </div>
                            <div class="form-group">
        ...
        ?>
       <!-- Modal edit -->
        <form action="<?php echo base_url().'admin/galeries/update_galeries'?>" method="post" enctype="multipart/form-data">
        <div class="modal" id="ModalEdit<?php echo $row->kd_galeries;?>" tabindex="-1" role="dialog" aria-labelledby="modal-normal" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        <div class="block-header bg-primary-dark">
                            <h3 class="block-title">Edit galeries</h3>
                            <div class="block-options">
                                <button type="button" class="btn-block-option" data-dismiss="modal" aria-label="Close">
                                    <i class="si si-close"></i>
                                </button>
                        ...
                        <div class="block-content">
                            ...
                            <div class="form-group">
                                <select name="xjadwal" class="form-control" required>
                                    <option value="">Select galeri</option>
                                    <?php foreach($galeri->result() as $j):?>
                                        <?php if($row->kd_galeri==$j->kd_galeri):?>
                                            <option value="<?php echo $j->kd_galeri;?>" selected><?php echo $j->nama;?></option>
                                        <?php else:?>
                                            <option value="<?php echo $j->kd_galeri;?>"><?php echo $j->nama;?></option>
                                        <?php endif;?>
                                    <?php endforeach;?>
                            ...
                            <!-- <div class="form-group">
                                <input type="text" name="xgaleries" value="<?php echo $row->galeries;?>" class="form-control" placeholder="galeries" required>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="modal-footer">
                        <input type="hidden" name="xkode" value="<?php echo $row->kd_galeries;?>" required>
                        <button type="button" class="btn btn-default btn-square" data-dismiss="modal">Close</button>
        ...
        <!-- Modal Hapus -->
        <form action="<?php echo base_url().'admin/galeries/hapus_galeries'?>" method="post">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content">
                            <p>Anda yakin mau menghapus galeries ini?</p>
