				...
				<div class="sidebar-content">
					...
					<div class="content-side content-side-full">
						<ul class="nav-main">
							...
							<li>
								<a href="<?php echo base_url() . 'admin/pelanggan'?>"><i class="si si-pencil"></i><span class="sidebar-mini-hide">Data Pesan</span></a>
							</li>
							<li>
								<a href="<?php echo base_url() . 'admin/penyewaan'?>"><i class="si si-pencil"></i><span class="sidebar-mini-hide">Laporan Data Penyewaan</span></a>
							</li>
						</ul>
					</div>
					<!-- END Side Navigation -->
		...
		<main id="main-container">
			...
			<div class="content">
				...
				<div class="row gutters-tiny invisible" data-toggle="appear">
					...
					$fasilitas_query = $this->db->query("SELECT * FROM fasilitas")->num_rows();
					$blog_query = $this->db->query("SELECT * FROM blog")->num_rows();
					?>
					<!-- Row #3 -->
					<div class="col-md-3">
						<div class="block">
							<div class="block-content block-content-full">
								<div class="py-20 text-center">
									...
									<div class="font-size-h4 font-w600"><?php echo $room_query; ?> Tipe Rooms/Suite</div>
					...
					<div class="col-md-3">
						<div class="block">
							<div class="block-content block-content-full">
								<div class="py-20 text-center">
									<div class="mb-20">
										<i class="fa fa-glass fa-4x text-info"></i>
									</div>
									<div class="font-size-h4 font-w600"><?php echo $fasilitas_query; ?> Fasilitas</div>
						...
						<div class="block">
							<div class="block-content block-content-full">
								<div class="py-20 text-center">
									...
									<div class="font-size-h4 font-w600"><?php echo $inbox_query; ?> Pesan Masuk</div>
					...
					<div class="col-md-3">
						<div class="block">
							<div class="block-content block-content-full">
								<div class="py-20 text-center">
									<div class="mb-20">
										<i class="fa fa-file-image-o fa-4x text-info"></i>
									</div>
									<div class="font-size-h4 font-w600"><?php echo $blog_query; ?> Blogs</div>
