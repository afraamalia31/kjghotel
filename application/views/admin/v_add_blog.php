...
<body>
	...
	<div id="page-container" class="sidebar-o side-scroll main-content-boxed side-trans-enabled page-header-fixed">
		...
		<main id="main-container">
			<!-- Page Content -->
			<div class="content">
				<form action="<?php echo base_url() . 'admin/blogs/simpan_blog' ?>" method="post" enctype="multipart/form-data">
					<div class="row">
						<div class="col-md-8">
							<div class="block">
								...
								<div class="block-content">
									...
									<div class="form-group">
										<input type="text" name="xjudul" class="form-control" placeholder="masukan judul" required>
									</div>
									<div class="form-group">
										<textarea name="xisi" id="ckeditor" required></textarea>
									</div>
									<div class="form-group">
										<input type="text" name="xauthor" class="form-control" placeholder="masukan nama author" required>
									</div>
									<div class="form-group">
										<input type="text" name="xtanggal" class="form-control" placeholder="masukan tanggal" required>
									</div>
									<div class="form-group">
										<input type="text" name="xlink" class="form-control" placeholder="masukan link" required>
									</div>
								</div>
							</div>
						</div>
