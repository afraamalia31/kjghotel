...
<body>
	...
	<div id="page-container" class="sidebar-o side-scroll main-content-boxed side-trans-enabled page-header-fixed">
		...
		<main id="main-container">
			<!-- Page Content -->
			<div class="content">
				<form action="<?php echo base_url() . 'admin/blogs/update_blog' ?>" method="post" enctype="multipart/form-data">
					<div class="row">
						<div class="col-md-8">
							<div class="block">
								<div class="block-header block-header-default">
									<h3 class="block-title">Edit Blogs</h3>
								</div>
								<div class="block-content">

									<div class="form-group">
										<input type="text" name="xjudul" value="<?php echo $b['blog_judul']; ?>" class="form-control" placeholder="Nama judul" required>
									</div>
									<div class="form-group">
										<textarea name="xisi" id="ckeditor" required><?php echo $b['blog_isi']; ?></textarea>
									</div>
									<div class="form-group">
										<input type="text" name="xauthor" value="<?php echo $b['blog_author']; ?>" class="form-control" placeholder="Nama Author" required>
									</div>
									<div class="form-group">
										<input type="text" name="xtanggal" value="<?php echo $b['blog_tanggal']; ?>" class="form-control" placeholder="Tanggal" required>
									</div>
									<div class="form-group">
										<input type="text" name="xlink" value="<?php echo $b['blog_link']; ?>" class="form-control" placeholder="Link blog" required>
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="block">
								...
								<div class="block-content">
									<div class="form-group">
										<input type="file" name="filefoto" class="dropify2" data-height="230" data-default-file="<?php echo base_url() . 'assets/images/' . $b['blog_gambar']; ?>">
									</div>


								</div>
								<div class="block-content block-content-full block-content-md bg-body-light">
									<input type="hidden" name="kode" value="<?php echo $b['blog_id']; ?>" required>
