...
<body>
								...
								<table id="mytable" class="table table-striped">
									...
									<tbody>
										...
										?>
											<tr>
												<td><?php echo $no; ?></td>
												<td><?php echo $row->review_nama; ?></td>
												<td><?php echo $row->review_des; ?></td>
												<td><?php echo $row->review_tanggal; ?></td>
												<td><img width="310px;" src="<?php echo base_url() . 'assets/images/' . $row->review_gambar; ?>"></td>
												<td style="width: 90px;text-align: center;">
													<a href="javascript:void(0);" class="btn btn-sm btn-secondary btn-circle btn-edit" data-id="<?php echo $row->review_id; ?>" data-nama="<?php echo $row->review_nama; ?>" data-des="<?php echo $row->review_des; ?>" data-tanggal="<?php echo $row->review_tanggal; ?>" data-gambar="<?php echo $row->review_gambar; ?>"><span class="fa fa-pencil"></span></a>
													<a href="javascript:void(0);" class="btn btn-sm btn-secondary btn-circle btn-hapus" data-id="<?php echo $row->review_id; ?>"><span class="fa fa-trash"></span></a>
												</td>
											</tr>
										<?php endforeach; ?>
									</tbody>
	...
	<!-- Modal Hapus -->
	<form action="<?php echo base_url() . 'admin/reviews/simpan_reviews' ?>" method="post" enctype="multipart/form-data">
				...
				<div class="modal-content">
					<div class="block block-themed block-transparent mb-0">
						...
						<div class="block-content">
							...
							<div class="form-group">
								<input type="text" name="xdes" class="form-control" placeholder="Ulasan" required>
							</div>
							<div class="form-group">
								<input type="text" name="xtanggal" class="form-control" placeholder="12 April 2023" required>
							</div>
							<div class="col-md-4">
                            <div class="block">
                                <div class="block-header block-header-default">
                                    <h3 class="block-title">Gambar</h3>
                                </div>
                                <div class="block-content">
                                    <div class="form-group">
	...
	<!-- Modal Hapus -->
	<form action="<?php echo base_url() . 'admin/reviews/update_reviews' ?>" method="post" enctype="multipart/form-data">
		<div class="modal" id="ModalUpdate" tabindex="-1" role="dialog" aria-labelledby="modal-normal" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="block block-themed block-transparent mb-0">
						<div class="block-header bg-primary-dark">
							<h3 class="block-title">Update reviews</h3>
							<div class="block-options">
								<button type="button" class="btn-block-option" data-dismiss="modal" aria-label="Close">
									<i class="si si-close"></i>
								</button>
						...
						<div class="block-content">
							<div class="form-group">
								<input type="text" name="xnama2" class="form-control" placeholder="Nama" required>
							</div>
							<div class="form-group">
								<input type="text" name="xdes2" class="form-control" placeholder="Ulasan" required>
							</div>
							<div class="form-group">
								<input type="text" name="xtanggal2" class="form-control" placeholder="12 April 2023" required>
							</div>
							<div class="col-md-4">
                            <div class="block">
                                <div class="block-header block-header-default">
	...
	<!-- Modal Hapus -->
	<form action="<?php echo base_url() . 'admin/reviews/hapus_reviews' ?>" method="post">
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="block block-themed block-transparent mb-0">
						...
						<div class="block-content">
							<p>Anda yakin mau menghapus reviews ini?</p>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('.btn-edit').on('click', function() {
				...
				$('[name="xdes2"]').val(des);
				$('[name="xtanggal2"]').val(tanggal);
				$('[name="file_name"]').val(gambar);
			});
