...
<body>
	...
	<div id="page-container" class="sidebar-o side-scroll main-content-boxed side-trans-enabled page-header-fixed">
		...
		<a href="<?php echo base_url() . 'admin/penyewaan/tambah_penyewaan'; ?>" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-plus"></span>Laporan Data Pemesanan Baru</a>
		</div>
		<br /><br />
