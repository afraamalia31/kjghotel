                            ...
                            <div class="block">
                                ...
                                <div class="block-content block-content-full">
                                    ...
                                    <div class="block">
                                        ...
                                        ?>
                                            <address>
                                                <strong>Kesatriyan Jogja Guesthouse</strong><br>
                                                <?php echo $k['des'];?><br>
                                                <abbr title="Alamat">Alamat:</abbr> <?php echo $k['alamat'];?><br>
                                                <abbr title="Phone">Phone:</abbr> <?php echo $k['telp'];?><br>
												<abbr title="Medsos">Tiktok:</abbr> <?php echo $k['medsos'];?>
                                            </address>
                                            <address>
            ...
            <footer id="page-footer" class="opacity-0">
                <div class="content py-20 font-size-xs clearfix">
                    ...
                    <div class="float-left">
                        <a class="font-w600" href="" target="_blank">Afra A</a> &copy; <span class="js-year-copy"><?php echo date('Y');?></span>
                    </div>
                </div>
            </footer>
            <!-- END Footer -->
                ...
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content">
							...
							<div class="form-group">
                                <input type="text" name="xmedsos" value="<?php echo $k['medsos'];?>" class="form-control" placeholder="Tiktok" required>
                            </div>
                            <div class="form-group">
