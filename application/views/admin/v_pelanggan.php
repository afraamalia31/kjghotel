...
<body>
				...
				<div class="sidebar-content">
					...
					<div class="content-side content-side-full">
						<ul class="nav-main">
							...
							<li>
								<a href="<?php echo base_url() . 'admin/pelanggan' ?>"><i class="si si-user"></i><span class="sidebar-mini-hide">Data Pesan</span></a>
							</li>
							<li>
								<a href="<?php echo base_url() . 'admin/penyewaan' ?>"><i class="si si-support"></i><span class="sidebar-mini-hide">Laporan Data Penyewaan</span></a>
							</li>
						</ul>
					</div>
					<!-- END Side Navigation -->
					...
					<div class="col-md-12">
						<div class="block">
							<div class="block-header block-header-default">
								<h3 class="block-title">Data Pesan</h3>
										...
										?>
											<tr>
												...
												<td style="width: 90px;text-align: center;">
													<a href="javascript:void(0);" class="btn btn-sm btn-secondary btn-circle btn-edit" data-id="<?php echo $row->id_pelanggan; ?>" data-nama="<?php echo $row->nama_pelanggan; ?>" data-gender="<?php echo $row->gender; ?>" data-telp="<?php echo $row->no_telp; ?>" data-alamat="<?php echo $row->alamat; ?>" data-email="<?php echo $row->email; ?>" data-kamar="<?php echo $row->tipe_kamar; ?>"><span class="fa fa-pencil"></span></a>
													<a href="javascript:void(0);" class="btn btn-sm btn-secondary btn-circle btn-hapus" data-id="<?php echo $row->id_pelanggan; ?>"><span class="fa fa-trash"></span></a>
												</td>
											</tr>
										<?php endforeach; ?>
									</tbody>
	...
	<!-- Modal Hapus -->
	<form action="<?php echo base_url() . 'admin/pelanggan/simpan_pelanggan' ?>" method="post">
				...
				<div class="modal-content">
					<div class="block block-themed block-transparent mb-0">
						...
						<div class="block-content">
							...
							<div class="form-group">
								<input type="text" name="xgender" class="form-control" placeholder="Gender" required>
							</div>
							<div class="form-group">
								<input type="text" name="xtelp" class="form-control" placeholder="telp" required>
							</div>
							<div class="form-group">
								<input type="text" name="xalamat" class="form-control" placeholder="alamat" required>
							</div>
							<div class="form-group">
								<input type="text" name="xemail" class="form-control" placeholder="email" required>
							</div>
							<div class="form-group">
								<input type="text" name="xkamar" class="form-control" placeholder="kamar" required>
							</div>
						</div>
	...
	<!-- Modal Hapus -->
	<form action="<?php echo base_url() . 'admin/pelanggan/update_pelanggan' ?>" method="post">
		<div class="modal" id="ModalUpdate" tabindex="-1" role="dialog" aria-labelledby="modal-normal" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="block block-themed block-transparent mb-0">
						<div class="block-header bg-primary-dark">
							<h3 class="block-title">Update pelanggan</h3>
							<div class="block-options">
								<button type="button" class="btn-block-option" data-dismiss="modal" aria-label="Close">
									<i class="si si-close"></i>
								</button>
						...
						<div class="block-content">
							...
							<div class="form-group">
								<input type="text" name="xgender2" class="form-control" placeholder="gender Event" required>
							</div>
							<div class="form-group">
								<input type="text" name="xtelp2" class="form-control" placeholder="telp" required>
							</div>
							<div class="form-group">
								<input type="text" name="xalamat2" class="form-control" placeholder="alamat" required>
							</div>
							<div class="form-group">
								<input type="text" name="xemail2" class="form-control" placeholder="email" required>
							</div>
							<div class="form-group">
								<input type="text" name="xkamar2" class="form-control" placeholder="kamar" required>
							</div>
	...
	<!-- Modal Hapus -->
	<form action="<?php echo base_url() . 'admin/pelanggan/hapus_pelanggan' ?>" method="post">
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="block block-themed block-transparent mb-0">
						...
						<div class="block-content">
							<p>Anda yakin mau menghapus pelanggan ini?</p>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('.btn-edit').on('click', function() {
				...
				$('[name="xgender2"]').val(gender);
				$('[name="xtelp2"]').val(telp);
				$('[name="xalamat2"]').val(alamat);
				$('[name="xemail2"]').val(email);
				$('[name="xkamar2"]').val(kamar);
			});
