				...
				<div class="sidebar-content">
						...
						<div class="content-header-section text-center align-parent sidebar-mini-hidden">
							...
							<div class="content-header-item">
								<a class="link-effect font-w700" href="<?php echo base_url() . 'admin/dashboard' ?>">
									...
									<span class="font-size-xl text-dual-primary-dark">K Jogja</span><span class="font-size-xl text-success"> Guesthouse</span>
								</a>
							</div>
							<!-- END Logo -->
						</div>
					...
					<div class="content-side content-side-full">
						<ul class="nav-main">
							...
							<li>
								<a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-pin"></i><span class="sidebar-mini-hide">Blog</span></a>
								<ul>
									<li>
										<a href="<?php echo base_url() . 'admin/tulisan/add_tulisan' ?>">Add</a>
									</li>

									<li>
										<a href="<?php echo base_url() . 'admin/tulisan' ?>">Blog</a>
									</li>
									<li>
							...
							<li>
								<a href="<?php echo base_url() . 'admin/room' ?>"><i class="si si-star"></i><span class="sidebar-mini-hide">Suite</span></a>
							</li>
							<li>
								<a href="<?php echo base_url() . 'admin/fasilitas' ?>"><i class="si si-badge"></i><span class="sidebar-mini-hide">Fasilitas</span></a>
							</li>
							<li>
							...
							<li>
								<a class="active" href="<?php echo base_url() . 'admin/inbox' ?>"><i class="si si-envelope"></i><span class="sidebar-mini-hide">Pesan Masuk</span></a>
							</li>
							<li>
