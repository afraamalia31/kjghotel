...
<body>
						...
						<div class="block">
							<div class="block-header block-header-default">
								...
								<div class="block-options">
									<a href="<?php echo site_url('admin/blogs/add_new'); ?>" class="btn btn-primary"><span class="fa fa-plus"></span> Add New</a>
								</div>
							</div>
									...
									<tbody>
										...
										?>
											<tr>
												...
												<td style="vertical-align: middle;"><?php echo $row->blog_judul; ?></td>
												<td style="vertical-align: middle;"><?php echo $row->blog_isi; ?></td>
												<td style="vertical-align: middle;"><?php echo $row->blog_author; ?></td>
												<td style="vertical-align: middle;"><?php echo $row->blog_tanggal; ?></td>
												<!-- <td class="link"><?php echo $row->blog_link; ?></td> -->
												<td><img width="310px;" src="<?php echo base_url() . 'assets/images/' . $row->blog_gambar; ?>"></td>
												<td style="width: 90px;text-align: center;vertical-align: middle;">
													<a href="<?php echo site_url('admin/blogs/edit/' . $row->blog_id); ?>" class="btn btn-sm btn-secondary btn-circle"><span class="fa fa-pencil"></span></a>
													<a href="javascript:void(0);" class="btn btn-sm btn-secondary btn-circle btn-hapus" data-id="<?php echo $row->blog_id; ?>"><span class="fa fa-trash"></span></a>
												</td>
											</tr>
										<?php endforeach; ?>
									</tbody>
	...
	<!-- Modal Hapus -->
	<form action="<?php echo base_url() . 'admin/blogs/hapus_blog' ?>" method="post">
				...
				<div class="modal-content">
					<div class="block block-themed block-transparent mb-0">
						...
						<div class="block-content">
							<p>Anda yakin mau menghapus Blog ini?</p>
