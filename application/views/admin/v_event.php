...
<body>
										...
										?>
											<tr>
												...
												<td style="width: 90px;text-align: center;">
													<a href="javascript:void(0);" class="btn btn-sm btn-secondary btn-circle btn-edit" data-id="<?php echo $row->event_id; ?>" data-nama="<?php echo $row->event_nama; ?>" data-jadwal="<?php echo $row->event_jadwal; ?>" data-tanggal="<?php echo $row->review_tanggal; ?>" data-gambar="<?php echo $row->review_gambar; ?>"><span class="fa fa-pencil"></span></a>
		...
		<footer id="page-footer" class="opacity-0">
			<div class="content py-20 font-size-xs clearfix">
				<div class="float-right">
					Created with <i class="fa fa-heart text-pulse"></i> by <a class="font-w600" href="" target="_blank"></a>
				</div>
	...
	<!-- Modal Hapus -->
	<form action="<?php echo base_url() . 'admin/events/simpan_events' ?>" method="post" enctype="multipart/form-data">
				...
				<div class="modal-content">
					<div class="block block-themed block-transparent mb-0">
						...
						<div class="block-content">
							...
							<div class="form-group">
								<input type="text" name="xjadwal" class="form-control" placeholder="Ulasan" required>
							</div>
							<div class="form-group">
	...
	<!-- Modal Hapus -->
	<form action="<?php echo base_url() . 'admin/events/update_events' ?>" method="post" enctype="multipart/form-data">
				...
				<div class="modal-content">
					<div class="block block-themed block-transparent mb-0">
						...
						<div class="block-content">
							...
							<div class="form-group">
								<input type="text" name="xjadwal2" class="form-control" placeholder="Ulasan" required>
							</div>
							<div class="form-group">
